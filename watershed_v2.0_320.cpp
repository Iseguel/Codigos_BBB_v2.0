...
{   
    ...
    VideoWriter wrtSRC("Watershed_servos_v2.0_320.avi", CV_FOURCC('X','V','I','D'), 15, Size(320,240));
  while(true)
  {
    ...
    */     
    ...
    if(Angulo>70 && Angulo<110){ //ADELANTE
      if(Modulo < 70){
            if(mc.x > 160){
                    escribeUART  = "5";  //CORRECCION DERECHA
                Arduino << escribeUART;
                usleep(2500);
                Arduino >> leeUART;
                usleep(2500);
                ...
                cout<< "DIRECCION CORREGIDA***DERECHA***" << endl;
                    ...
                    escribeUART  = "3";  //CORRECCION IZQUIERDA
                Arduino << escribeUART;
                usleep(2500);
                Arduino >> leeUART;
                usleep(2500);
