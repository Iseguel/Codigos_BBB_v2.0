...
{   
    ...
    VideoWriter wrtSRC("TestFloodFill_v2.0_640.avi", CV_FOURCC('X','V','I','D'), 15/2, Size(640,480));
  ...
  while(true)
  {
    ...
    if(cont == 5){
        ...
        bitwise_or(Mascara5,maskResult3,maskResult4);
        bitwise_or(Mascara6,maskResult4,maskResult);
 ...
 */ 
    ...
    angulo = (anguloVect[0] + anguloVect[1] + anguloVect[2]);
    anguloProm = angulo/3;

    //cout << "angulo total:" << angulo << " --> promedio:" << anguloProm <<endl;
